...
ifeq ($(GOOS),windows)
OUTPUT_PATH = ${BUILD_DIR}/baton-okta-aws-federation.exe
else
OUTPUT_PATH = ${BUILD_DIR}/baton-okta-aws-federation
endif
...
build: $(GENERATED_CONF)
	go build ${BUILD_TAGS} -o ${OUTPUT_PATH} ./cmd/baton-okta-aws-federation
